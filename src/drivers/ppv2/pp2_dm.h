...
#define DM_RXD_GET_L4_HDR_ERR(desc)     (((desc)->cmds[0] & RXD_IP_HDR_ERR_MASK) >> 24)
...
#define DM_TXD_SET_POOL_ID(desc, data)      ((desc)->cmds[0] = ((desc)->cmds[0] & ~TXD_POOL_ID_MASK) | (data << 16 & TXD_POOL_ID_MASK))
#define DM_TXD_SET_PKT_OFF_EXT(desc, data)  ((desc)->cmds[0] = ((desc)->cmds[0] & ~TXD_PKT_OFF_EXT_MASK) | (data << 20 & TXD_PKT_OFF_EXT_MASK))
#define DM_TXD_SET_HWF_SYNC(desc, data)     ((desc)->cmds[0] = ((desc)->cmds[0] & ~TXD_HWF_SYNC_MASK) | (data << 21 & TXD_HWF_SYNC_MASK))
#define DM_TXD_SET_HWF(desc, data)          ((desc)->cmds[0] = ((desc)->cmds[0] & ~TXD_HWF_MASK) | (data << 22 & TXD_HWF_MASK))
#define DM_TXD_SET_PADD_DSBL(desc, data)    ((desc)->cmds[0] = ((desc)->cmds[0] & ~TXD_PADD_DSBL_MASK) | (data << 23 & TXD_PADD_DSBL_MASK))
#define DM_TXD_SET_L4_INFO(desc, data)      ((desc)->cmds[0] = ((desc)->cmds[0] & ~TXD_L4_INFO_MASK) | (data << 24 & TXD_L4_INFO_MASK))
#define DM_TXD_SET_L3_INFO(desc, data)      ((desc)->cmds[0] = ((desc)->cmds[0] & ~TXD_L3_INFO_MASK) | (data << 26 & TXD_L3_INFO_MASK))
#define DM_TXD_SET_L(desc, data)            ((desc)->cmds[0] = ((desc)->cmds[0] & ~TXD_L_MASK) | (data << 28 & TXD_L_MASK))
#define DM_TXD_SET_F(desc, data)            ((desc)->cmds[0] = ((desc)->cmds[0] & ~TXD_F_MASK) | (data << 29 & TXD_F_MASK))
...
#define DM_TXD_SET_BUF_HDR(desc, data)      ((desc)->cmds[0] = ((desc)->cmds[0] & ~TXD_BUF_HDR_MASK) | (data << 31 & TXD_BUF_HDR_MASK))
#define DM_TXD_SET_PKT_OFF(desc, data)      ((desc)->cmds[1] = ((desc)->cmds[1] & ~TXD_PKT_OFF_MASK) | (data << 0 & TXD_PKT_OFF_MASK))
#define DM_TXD_SET_DEST_QID(desc, data)     ((desc)->cmds[1] = ((desc)->cmds[1] & ~TXD_DEST_QID_MASK) | (data << 8 & TXD_DEST_QID_MASK))
#define DM_TXD_SET_BYTE_COUNT(desc, data)   ((desc)->cmds[1] = ((desc)->cmds[1] & ~TXD_BYTE_COUNT_MASK) | (data << 16 & TXD_BYTE_COUNT_MASK))
#define DM_TXD_SET_GEM_PID_PTT(desc, data)  ((desc)->cmds[2] = ((desc)->cmds[2] & ~TXD_GEM_PID_PTT_MASK) | (data << 0 & TXD_GEM_PID_PTT_MASK))
#define DM_TXD_SET_DP(desc, data)           ((desc)->cmds[2] = ((desc)->cmds[2] & ~TXD_DP_MASK) | (data << 12 & TXD_DP_MASK))
#define DM_TXD_SET_DSATAG(desc, data)       ((desc)->cmds[2] = ((desc)->cmds[2] & ~TXD_DSATAG_MASK) | (data << 14 & TXD_DSATAG_MASK))
#define DM_TXD_SET_L4_INIT_CHK(desc, data)  ((desc)->cmds[2] = ((desc)->cmds[2] & ~TXD_L4_INIT_CHK_MASK) | (data << 16 & TXD_L4_INIT_CHK_MASK))
#define DM_TXD_SET_DPTR(desc, data)         ((desc)->cmds[3] = ((desc)->cmds[3] & ~TXD_PME_DPTR_MASK) | (data << 0 & TXD_PME_DPTR_MASK))
#define DM_TXD_SET_PME_PROGRAM(desc, data)  ((desc)->cmds[3] = ((desc)->cmds[3] & ~TXD_PME_PROGRAM_MASK) | (data << 16 & TXD_PME_PROGRAM_MASK))
#define DM_TXD_SET_HWF_IDB(desc, data)      ((desc)->cmds[3] = ((desc)->cmds[3] & ~TXD_HWF_IDB_MASK) | (data << 24 & TXD_HWF_IDB_MASK))
#define DM_TXD_SET_GEM_OEM(desc, data)      ((desc)->cmds[3] = ((desc)->cmds[3] & ~TXD_GEM_OEM_MASK) | (data << 25 & TXD_GEM_OEM_MASK))
#define DM_TXD_SET_ERR_SUM(desc, data)      ((desc)->cmds[3] = ((desc)->cmds[3] & ~TXD_ERR_SUM_MASK) | (data << 26 & TXD_ERR_SUM_MASK))
#define DM_TXD_SET_PON_FEC(desc, data)      ((desc)->cmds[3] = ((desc)->cmds[3] & ~TXD_PON_FEC_MASK) | (data << 27 & TXD_PON_FEC_MASK))
#define DM_TXD_SET_CPU_ID(desc, data)       ((desc)->cmds[3] = ((desc)->cmds[3] & ~TXD_CPU_ID_MASK) | (data << 28 & TXD_CPU_ID_MASK))
#define DM_TXD_SET_PTP_DESC(desc, data)     ((desc)->cmds[5] = ((desc)->cmds[5] & ~TXD_PTP_DESC_MASK) | (data << 8 & TXD_PTP_DESC_MASK))
#define DM_TXD_SET_QSET_NO(desc, data)      ((desc)->cmds[7] = ((desc)->cmds[7] & ~TXD_BUF_QSET_NO_MASK) | (data << 8 & TXD_BUF_QSET_NO_MASK))
#define DM_TXD_SET_TYPE(desc, data)         ((desc)->cmds[7] = ((desc)->cmds[7] & ~TXD_BUF_TYPE_MASK) | (data << 15 & TXD_BUF_TYPE_MASK))
#define DM_TXD_SET_DSCP(desc, data)         ((desc)->cmds[7] = ((desc)->cmds[7] & ~TXD_MOD_DSCP_MASK) | (data << 16 & TXD_MOD_DSCP_MASK))
#define DM_TXD_SET_PRI(desc, data)          ((desc)->cmds[7] = ((desc)->cmds[7] & ~TXD_MOD_PRI_MASK) | (data << 22 & TXD_MOD_PRI_MASK))
#define DM_TXD_SET_DSCP_EN(desc, data)      ((desc)->cmds[7] = ((desc)->cmds[7] & ~TXD_MOD_DSCP_EN_MASK) | (data << 25 & TXD_MOD_DSCP_EN_MASK))
#define DM_TXD_SET_PRI_EN(desc, data)       ((desc)->cmds[7] = ((desc)->cmds[7] & ~TXD_MOD_PRI_EN_MASK) | (data << 26 & TXD_MOD_PRI_EN_MASK))
#define DM_TXD_SET_GEM_EN(desc, data)       ((desc)->cmds[7] = ((desc)->cmds[7] & ~TXD_MOD_GEM_EN_MASK) | (data << 27 & TXD_MOD_GEM_EN_MASK))
#define DM_TXD_SET_PHYSADDR(desc, data)      \
    do { \
              (desc)->cmds[4] = (uint32_t)(uintptr_t)data; \
              (desc)->cmds[5] = ((desc)->cmds[5] & ~TXD_BUF_PHYS_HI_MASK) | ((uintptr_t)data >> 32 & TXD_BUF_PHYS_HI_MASK); \
    } while (0)
#define DM_TXD_SET_VIRTADDR(desc, data)      \
    do { \
              (desc)->cmds[6] = (uint32_t)(uintptr_t)data; \
              (desc)->cmds[7] = ((desc)->cmds[7] & ~TXD_BUF_VIRT_HI_MASK) | ((uintptr_t)data >> 32 & TXD_BUF_VIRT_HI_MASK); \
    } while (0)
